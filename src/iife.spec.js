describe('Immediately Invoked Function Expressions', function(){

	it("don't pollute global scope", function(){
	...
	it('can be used with closures to remember value at a time', function(){
